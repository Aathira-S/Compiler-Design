...
// Printing action
printf("\n$%s\t%s$\t", stk, a);
// Call check function ..which will check the stack whether its 
contain any production or not
check();
}
// Rechecking last time if contain any valid production then it will
